...
import SnakeSettings from "../modules/snake/SnakeSettings";
...
export const modules: readonly ToolboxModule[] = [
  { id: "snake", name: "贪吃蛇", route: "/snake", component: SnakePage, icon: Gamepad2, category: "休闲", settingsComponent: SnakeSettings },
